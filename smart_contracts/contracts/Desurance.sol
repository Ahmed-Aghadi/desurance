...
contract Desurance is Ownable {
    ...
    constructor(
        ...
        require(minMembers > 0, "Desurance: minMembers should be greater than 0");
        require(requestTime > 0, "Desurance: requestTime should be greater than 0");
        require(validity > 0, "Desurance: validity should be greater than 0");
        require(claimTime > 0, "Desurance: judgingStartTime should be greater than 0");
        require(judgingTime > 0, "Desurance: judgingTime should be greater than 0");
        require(judgesLength > 0, "Desurance: judgesLength should be greater than 0");
        require(
            judgesLength <= minMembers,
            "Desurance: judgesLength should be less than or equal to minMembers"
        );
        require(amount > 0, "Desurance: amount should be greater than 0");
        require(
            percentDivideIntoJudges > 0,
            "Desurance: percentDivideIntoJudges should be greater than 0"
        );
        require(
            percentDivideIntoJudges <= 100,
            "Desurance: percentDivideIntoJudges should be less than or equal to 100"
        );
